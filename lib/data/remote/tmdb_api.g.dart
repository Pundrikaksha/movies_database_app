...
class _TmdbApi implements TmdbApi {
  ...
  @override
  Future<MoviesResponse> trending(int page) async {
  ...
  @override
  Future<MoviesResponse> nowPlaying(int page, String region) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page, r'region': region};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MoviesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
  ...
  @override
  Future<Movie> details(int id) async {
    final _extra = <String, dynamic>{};
